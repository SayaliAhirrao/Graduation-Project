...
if(isset($_POST['app_search_submit']))
{
	...
	$query = "select * from appointmenttable where contact= '$contact';";
  ...
  <table class='table table-hover'>
    ...
    echo "</tbody></table><center><a href='admin-panel1.php' class='btn btn-light'>Back to Reception</a></div></center></div></div></div>";
  }
  }
