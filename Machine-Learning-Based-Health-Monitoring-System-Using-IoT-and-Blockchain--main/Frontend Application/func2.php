...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patientregistration(fname,lname,gender,email,contact,password,cpassword) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword');";
    ...
    $query1 = "select * from patientregistration;";
...
{
	$name=$_POST['name'];
	$query="insert into doctortable(name)values('$name')";
	$result=mysqli_query($con,$query);
	if($result)
