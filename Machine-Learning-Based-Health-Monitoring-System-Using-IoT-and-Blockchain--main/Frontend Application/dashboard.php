...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%; ">
                      <br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img style="margin-left: 55px;" src="https://sdramproject.s3.us-east-2.amazonaws.com/css/isu.png" width="270" height="270"/>

                    </div>
                    <div class="col-md-9 register-right" style="margin: auto; margin-top: 50px; left: 70px; background-color: white">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a style="color: #e51937;" href="patient_login.php">Already have an account? Please Login</a>
                                        </div>
                                    </div>
...
<!---start-copy-right----->
                <div class="copy-tight">
                    ...
                    <p style="color: white; text-align: center; font-size: 15px; font-family: 'IBM Plex Sans'">&copy;  <b>2020 www.eHealth.com All Rights Reserved&nbsp;&nbsp;&nbsp;&nbsp; Powered by Illinois State University,&nbsp;Normal IL</b><p>                </div>
                <!---End-copy-right----->
